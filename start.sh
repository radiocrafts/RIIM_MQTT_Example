...
then
    ...
    if [ $UploadICI == "y" ]
    then
    python3 ./rc18xx_bootloader_utility/rc188x_bootloader_utility.py load-image -t 100 -p $BRPort -f ../ICI_Applications/Example/Output/BR.bin
    fi
    ...
    if [ $UploadICI == "y" ]
    then
    python3 ./rc18xx_bootloader_utility/rc188x_bootloader_utility.py load-image -t 100 -p $MRPort -f ../ICI_Applications/Example/Output/MR.bin
    fi
fi
